...
export const Section = styled.section<{ $active: boolean }>`
  ...
  border: ${(props) => props.theme["border-widths"].regular} ${props => props.$active?"solid":"dashed"} ${(props) => props.theme.success};
  border-radius: ${(props) => props.theme.radii.lg};
  box-shadow: 0px 0px 10px ${props => props.$active?props.theme.success:"transparent"};
  display: flex;
