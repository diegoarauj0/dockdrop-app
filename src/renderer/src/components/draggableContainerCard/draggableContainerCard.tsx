...
interface IDraggableContainerCardProps extends ContainerInfo {
  draggableId: string;
}

export function DraggableContainerCardComponent(props: IDraggableContainerCardProps): React.ReactNode {
